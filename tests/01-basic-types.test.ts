...
// ============================================================
// ここに回答 ↓（: の後の型を書き換える）
const q1Answer: any = "Hello TypeScript";
// ヒント: 文字列を格納するための基本型は？
...
// ============================================================
// ここに回答 ↓
const q5Answer: any = ["React", "Vue", "Angular"];
...
// ============================================================
// ここに回答 ↓
function q7Answer(message: any): any {
  // ここに処理を書く
}
...
// ここに回答 ↓
function q9Answer() {
  const statuses = ["todo", "doing", "done"]; // as const をつけてみよう
  return statuses;
}
...
// ============================================================
// ここに回答 ↓
const q10Answer: any = { id: 1, name: "テスト", active: true };
...
function runChapter01Tests(): ChapterResult {
  ...
  results.push(runTest(10, "オブジェクトのインライン型宣言", () => {
